...
robot.log_data_with_cmd(filename='{}/{}_{}.csv'.format(name, profile, t), move_cmd=robot.movej, cmd_args=(B, 4))
#robot.movej(B, t=4)
...
robot.log_data_with_cmd(filename='{}/{}_{}.csv'.format(name, profile, t), move_cmd=robot.movel, cmd_args=(B, False, True))
...
plot.add_headers('{}/{}_{}.csv'.format(name, profile, t))
plot.reset_time('{}/{}_{}_named.csv'.format(name, profile, t))
plot.plot_all('{}/{}_{}_named_zeroed.csv'.format(name, profile, t))
